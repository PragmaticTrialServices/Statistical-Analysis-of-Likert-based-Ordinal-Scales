...
* **`Wpbias`**: Bias of the win-probability estimate: $\displaystyle\overline{\widehat{\mathrm{WinP}}} - \mathrm{WinP}_{\text{true}}$, where $\mathrm{WinP}_{\text{true}}$ is estimated using Harrell’s approximation.
